"""
URL configuration for pixelplaylist project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Pixel Playlist API",
        default_version='v1',
        description="API for Pixel Playlist",
    ),
    public=True,
...
urlpatterns = [
    ...
    path('api/token/', EmailTokenObtainPairView.as_view(), name='token_obtain_pair'), # Auth
